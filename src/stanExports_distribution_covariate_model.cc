...
#include "stanExports_distribution_covariate_model.h"

RCPP_MODULE(stan_fit4distribution_covariate_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_distribution_covariate_model")
